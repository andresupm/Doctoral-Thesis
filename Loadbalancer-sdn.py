...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if datapath.id == 1:
            ...
            #add the return flow for h1 in BalancerNet:  
	    ...
	    # add group tables
            ...
            #add the return flow for S1,S2,S3,S4 in br0 de vnfT2.  
            # Servers are connected to port LOCAL.
            actions = [parser.OFPActionOutput(1)]
            match = parser.OFPMatch(in_port=2)
            self.add_flow(datapath, 10, match, actions)
        ...
        # switch br0 de vnfT1
        if datapath.id == 2: ##obtener el datapath del ovs
        ...
        # switch br0 de vnfT1-2
        if datapath.id == 3: ##obtemer el datapath del ovs
            # h1 is connected to port 3.
            actions = [parser.OFPActionOutput(2)]
            match = parser.OFPMatch(in_port=1)
            self.add_flow(datapath, 10, match, actions)
